"""
Optional translation helpers for the backend.
"""
...
def translate_text_bundle(
    ...
    for index, chapter in enumerate(chapters, start=1):
        ...
        translated_paragraphs = [
            _translate_text(paragraph, translator) for paragraph in chapter.paragraphs
        ]
        translated_chapters.append(
            replace(chapter, title=translated_title, paragraphs=translated_paragraphs)
        )
